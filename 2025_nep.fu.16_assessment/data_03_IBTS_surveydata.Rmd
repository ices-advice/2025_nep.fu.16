...
* igfs_nep_final_IBTS_2024.csv


Files after (inside "data/data_03_IBTS_surveydata"):

* FU16_IGFS-WIBTS-Q4_G7212_LFD.png
...
This Rmarkdown document plots the catch length frequency data from the IBTS surveys for Nephrops in FU 16.
IGFS-WIBTS-Q4 [G7212] 
...
### IGFS-WIBTS-Q4 [G7212] LFD plot FU 16
<a href="#top">Back to top</a>
...
d <- cs %>% filter(fu=='16') %>% group_by(year, CLmm, sex) %>% summarise (n = sum(n), nn=sum(n))
...
png("data/data_03_IBTS_surveydata/FU16_IGFS_LFD.png", height=1700, width=1200, res=200)

plot.ld(df, "FU 16", 2003, 2024, 25, 35)
